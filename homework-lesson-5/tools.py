...
def knowledge_search(query: str) -> str:
    ...
    Returns plain-text context blocks for the top matches, including document number, source, page, chunk ID, and a relevant content snippet."""
        ...
        context_blocks.append(
            "\n".join(
                [
                    ...
                    f"Content: {doc.page_content[:settings.max_knowledge_context_length].strip()}",
                ]
            )
        )
